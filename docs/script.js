...
const LANGS = {
  en: {
    ...
    'dd.hvnc.p1':'HVNC creates a completely isolated Windows desktop session — invisible to the target. Chrome, Firefox, Edge, Brave, Opera launch directly into the shadow session. The victim sees nothing. You see everything.',
    ...
    'dd.hvnc.tag1':'isolated desktop','dd.hvnc.tag2':'8 browsers','dd.hvnc.tag3':'clipboard sync','dd.hvnc.tag4':'real-time input',
  ...
  fr: {
    ...
    'dd.hvnc.p1':'HVNC crée une session bureau Windows totalement isolée — invisible pour la cible. Chrome, Firefox, Edge, Brave, Opera se lancent directement dans la session fantôme. La victime ne voit rien. Vous voyez tout.',
    ...
    'dd.hvnc.tag1':'bureau isolé','dd.hvnc.tag2':'8 navigateurs','dd.hvnc.tag3':'sync presse-papier','dd.hvnc.tag4':'saisie temps réel',
  ...
  es: {
    ...
    'dd.hvnc.p1':'HVNC crea una sesión de escritorio Windows completamente aislada — invisible para el objetivo. Chrome, Firefox, Edge, Brave, Opera se lanzan directamente en la sesión sombra. La víctima no ve nada. Tú lo ves todo.',
    ...
    'dd.hvnc.tag1':'escritorio aislado','dd.hvnc.tag2':'8 navegadores','dd.hvnc.tag3':'sync portapapeles','dd.hvnc.tag4':'entrada en tiempo real',
  ...
  de: {
    ...
    'dd.hvnc.p1':'HVNC erstellt eine vollständig isolierte Windows-Desktop-Sitzung — für das Ziel unsichtbar. Chrome, Firefox, Edge, Brave, Opera starten direkt in der Schatten-Sitzung. Das Opfer sieht nichts. Du siehst alles.',
    ...
    'dd.hvnc.tag1':'isolierter Desktop','dd.hvnc.tag2':'8 Browser','dd.hvnc.tag3':'Clipboard-Sync','dd.hvnc.tag4':'Echtzeiteingabe',
  ...
  pt: {
    ...
    'dd.hvnc.p1':'HVNC cria uma sessão de desktop Windows completamente isolada — invisível para o alvo. Chrome, Firefox, Edge, Brave, Opera são iniciados diretamente na sessão sombra. A vítima não vê nada. Você vê tudo.',
    ...
    'dd.hvnc.tag1':'desktop isolado','dd.hvnc.tag2':'8 navegadores','dd.hvnc.tag3':'sync clipboard','dd.hvnc.tag4':'entrada em tempo real',
    'dd.runpe.h3':'Process Hollowing — RunPE x64',
  ...
  ru: {
    ...
    'dd.hvnc.p1':'HVNC создаёт полностью изолированный сеанс рабочего стола Windows — невидимый для цели. Chrome, Firefox, Edge, Brave, Opera запускаются прямо в теневом сеансе. Жертва ничего не видит. Вы видите всё.',
    ...
    'dd.hvnc.tag1':'изолированный стол','dd.hvnc.tag2':'8 браузеров','dd.hvnc.tag3':'синхронизация буфера','dd.hvnc.tag4':'ввод в реальном времени',
  ...
  zh: {
    ...
    'dd.hvnc.h3':'隐藏虚拟网络计算',
    'dd.hvnc.p1':'HVNC 创建完全隔离的 Windows 桌面会话 — 对目标不可见。Chrome、Firefox、Edge、Brave、Opera 直接在影子会话中启动。受害者什么都看不到。你看到一切。',
    'dd.hvnc.p2a':'每个浏览器均带有 ','dd.hvnc.p2b':'，填满 HVNC 画面。鼠标和键盘以像素精度转发。剪贴板按需同步。',
    'dd.hvnc.tag1':'隔离桌面','dd.hvnc.tag2':'8 浏览器','dd.hvnc.tag3':'剪贴板同步','dd.hvnc.tag4':'实时输入',
  ...
  ja: {
    ...
    'dd.hvnc.p1':'HVNCは完全に隔離されたWindowsデスクトップセッションを作成します — ターゲットには見えません。Chrome、Firefox、Edge、Brave、Operaがシャドウセッションに直接起動します。被害者は何も見えません。あなたはすべてを見ます。',
    'dd.hvnc.p2a':'各ブラウザは ','dd.hvnc.p2b':' でHVNCフレームを埋めます。マウスとキーボードはピクセル精度で転送。クリップボードはオンデマンドで同期されます。',
    'dd.hvnc.tag1':'隔離デスクトップ','dd.hvnc.tag2':'8ブラウザ','dd.hvnc.tag3':'クリップボード同期','dd.hvnc.tag4':'リアルタイム入力',
  ...
  ar: {
    ...
    'dd.hvnc.p1':'يُنشئ HVNC جلسة سطح مكتب Windows معزولة تمامًا — غير مرئية للهدف. يُطلق Chrome وFirefox وEdge وBrave وOpera مباشرةً في الجلسة الظلية. الضحية لا ترى شيئًا. أنت ترى كل شيء.',
    ...
    'dd.hvnc.tag1':'سطح مكتب معزول','dd.hvnc.tag2':'8 متصفحات','dd.hvnc.tag3':'مزامنة الحافظة','dd.hvnc.tag4':'إدخال فوري',
  ...
  it: {
    ...
    'dd.hvnc.p1':'HVNC crea una sessione desktop Windows completamente isolata — invisibile al bersaglio. Chrome, Firefox, Edge, Brave, Opera si avviano direttamente nella sessione ombra. La vittima non vede nulla. Tu vedi tutto.',
    ...
    'dd.hvnc.tag1':'desktop isolato','dd.hvnc.tag2':'8 browser','dd.hvnc.tag3':'sync appunti','dd.hvnc.tag4':'input in tempo reale',
  ...
  nl: {
    ...
    'dd.hvnc.p1':'HVNC maakt een volledig geïsoleerde Windows desktopsessie — onzichtbaar voor het doelwit. Chrome, Firefox, Edge, Brave, Opera starten rechtstreeks in de schaduwsessie. Het slachtoffer ziet niets. Jij ziet alles.',
    ...
    'dd.hvnc.tag1':'geïsoleerde desktop','dd.hvnc.tag2':'8 browsers','dd.hvnc.tag3':'klembord-sync','dd.hvnc.tag4':'realtime invoer',
    'dd.runpe.h3':'Process Hollowing — RunPE x64',
  ...
  tr: {
    ...
    'dd.hvnc.p1':'HVNC tamamen izole bir Windows masaüstü oturumu oluşturur — hedef için görünmez. Chrome, Firefox, Edge, Brave, Opera doğrudan gölge oturumuna başlatılır. Kurban hiçbir şey görmez. Sen her şeyi görürsün.',
    ...
    'dd.hvnc.tag1':'izole masaüstü','dd.hvnc.tag2':'8 tarayıcı','dd.hvnc.tag3':'pano senkronu','dd.hvnc.tag4':'gerçek zamanlı giriş',
  ...
  ko: {
    ...
    'dd.hvnc.p1':'HVNC는 완전히 격리된 Windows 데스크톱 세션을 생성합니다 — 대상에게 보이지 않습니다. Chrome, Firefox, Edge, Brave, Opera가 그림자 세션에 직접 실행됩니다. 피해자는 아무것도 보지 못합니다. 당신은 모든 것을 봅니다.',
    'dd.hvnc.p2a':'각 브라우저는 ','dd.hvnc.p2b':'로 실행되어 HVNC 프레임을 채웁니다. 마우스와 키보드는 픽셀 단위 정확도로 전달됩니다. 클립보드는 요청 시 동기화됩니다.',
    'dd.hvnc.tag1':'격리 데스크톱','dd.hvnc.tag2':'8 브라우저','dd.hvnc.tag3':'클립보드 동기화','dd.hvnc.tag4':'실시간 입력',
  ...
  pl: {
    ...
    'dd.hvnc.p1':'HVNC tworzy w pełni izolowaną sesję pulpitu Windows — niewidoczną dla celu. Chrome, Firefox, Edge, Brave, Opera uruchamiają się bezpośrednio w ukrytej sesji. Ofiara nic nie widzi. Ty widzisz wszystko.',
    ...
    'dd.hvnc.tag1':'izolowany pulpit','dd.hvnc.tag2':'8 przeglądarek','dd.hvnc.tag3':'sync schowka','dd.hvnc.tag4':'wejście w czasie rzeczywistym',
    'dd.runpe.h3':'Process Hollowing — RunPE x64',
  ...
  id: {
    ...
    'dd.hvnc.p1':'HVNC membuat sesi desktop Windows yang sepenuhnya terisolasi — tidak terlihat oleh target. Chrome, Firefox, Edge, Brave, Opera diluncurkan langsung ke dalam sesi bayangan. Korban tidak melihat apa-apa. Anda melihat segalanya.',
    ...
    'dd.hvnc.tag1':'desktop terisolasi','dd.hvnc.tag2':'8 browser','dd.hvnc.tag3':'sinkron clipboard','dd.hvnc.tag4':'input real-time',
    'dd.runpe.h3':'Process Hollowing — RunPE x64',
  ...
  vi: {
    ...
    'dd.hvnc.p1':'HVNC tạo ra một phiên máy tính để bàn Windows hoàn toàn cô lập — vô hình với mục tiêu. Chrome, Firefox, Edge, Brave, Opera khởi chạy trực tiếp vào phiên ẩn. Nạn nhân không thấy gì. Bạn thấy tất cả.',
    ...
    'dd.hvnc.tag1':'desktop cô lập','dd.hvnc.tag2':'8 trình duyệt','dd.hvnc.tag3':'đồng bộ clipboard','dd.hvnc.tag4':'nhập liệu thời gian thực',
    'dd.runpe.h3':'Process Hollowing — RunPE x64',
  ...
  uk: {
    ...
    'dd.hvnc.p1':'HVNC створює повністю ізольований сеанс робочого стола Windows — невидимий для цілі. Chrome, Firefox, Edge, Brave, Opera запускаються прямо у тіньовому сеансі. Жертва нічого не бачить. Ви бачите все.',
    ...
    'dd.hvnc.tag1':'ізольований стіл','dd.hvnc.tag2':'8 браузерів','dd.hvnc.tag3':'синхронізація буфера','dd.hvnc.tag4':'введення в реальному часі',
  ...
  he: {
    ...
    'dd.hvnc.p1':'HVNC יוצר סשן שולחן עבודה של Windows מבודד לחלוטין — בלתי נראה לקורבן. Chrome, Firefox, Edge, Brave, Opera מופעלים ישירות לתוך הסשן הצללי. הקורבן לא רואה דבר. אתה רואה הכל.',
    'dd.hvnc.p2a':'כל דפדפן מקבל ','dd.hvnc.p2b':' וממלא את מסגרת HVNC. עכבר ומקלדת מועברים בדיוק פיקסלי. לוח הגזירות מסונכרן לפי דרישה.',
    'dd.hvnc.tag1':'שולחן עבודה מבודד','dd.hvnc.tag2':'8 דפדפנים','dd.hvnc.tag3':'סנכרון לוח גזירות','dd.hvnc.tag4':'קלט בזמן אמת',
