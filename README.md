...
![Version](https://img.shields.io/badge/version-1.6.9-orange.svg)
...
> ***v1.6.9*** — DevExpress build: local DLL refs used as fast path when DevExpress 25.2 is installed (0.4s restore); NuGet fallback for machines without a local install.
