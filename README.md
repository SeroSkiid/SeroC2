...
> ***v1.7.9*** — DevExpress build: local DLL refs used as fast path when DevExpress 25.2 is installed (0.4s restore); NuGet fallback for machines without a local install.
...
- ![VS2022](https://img.shields.io/badge/Visual%20Studio-2022-purple?logo=visualstudio) **Visual Studio 2022** with ...
